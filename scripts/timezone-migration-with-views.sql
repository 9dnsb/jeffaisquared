-- ============================================================================
-- Timezone Migration with Views
-- ============================================================================
-- This script:
-- 1. Drops existing views that depend on timestamp columns
-- 2. Converts all timestamp columns to timestamptz
...
SELECT 'Timezone migration completed successfully! All views recreated.' as status;
