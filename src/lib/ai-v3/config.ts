...
export const AI_V3_CONFIG: AIv3Config = {
  ...
  performance: {
    queryTimeout: 15000, // 10 second max query time (user requirement)
...
export const ERROR_MESSAGES = {
  TIMEOUT:
    'Query took too long to process. Try narrowing your request or specifying a smaller date range.',
  NO_DATA:
    'No data found matching your criteria. Please check your filters and try again.',
  PARAMETER_EXTRACTION_FAILED:
    'I had trouble understanding your request. Could you please rephrase or be more specific?',
  DATABASE_ERROR:
    'There was an error accessing the data. Please try again in a moment.',
  INVALID_DATE_RANGE:
    'The date range you specified is invalid. Please check the dates and try again.',
  LOCATION_NOT_FOUND:
    'The location you mentioned was not found. Available locations include: {locations}',
  ITEM_NOT_FOUND:
    'The item you mentioned was not found. Please check the spelling or try a broader search.',
