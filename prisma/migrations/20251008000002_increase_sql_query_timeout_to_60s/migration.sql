-- ============================================================================
-- Increase statement timeout for exec_sql_query function to 60 seconds
-- ============================================================================
-- This migration updates exec_sql_query to set a 60-second statement timeout
...
COMMENT ON FUNCTION exec_sql_query IS 'Safely executes SELECT-only SQL queries for AI-generated Text-to-SQL RAG system with 60s timeout and security validations';
